...
<script lang="ts" name="homeai-learn-category" setup>
  ...
  const {
    ...
    api: {
      list: (params) => learnApi.categoryList(params),
      add: (data) => learnApi.addCategory(data),
      edit: (data) => learnApi.editCategory(data),
      delete: (id) => learnApi.deleteCategory(id),
    },
    defaultFormValues: { icon: '📖', color: '#999', sortOrder: 0, isEnabled: 1 },
