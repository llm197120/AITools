...
version: v3
status: 进行中（第 13～19 轮已落地）
updated: 2026-08-12
---

# 家庭AI小工具 - 迭代优化路线图

> 本文档汇总第 **1～12 轮**业务迭代，以及 **第 13～19 轮**工程化/业务/视觉优化落地内容。  
> 业务模块后续建议见第三节。
...
| P2 | 智能推荐 | 按季节、家庭口味、历史做过次数推荐 | ✅ 第 28 轮轻量版（计划/收藏/季节加权热门）；✅ 第 30 轮「新菜尝鲜」独立区块 |
...
| P2 | 用户空间配额 | 默认用户上限（Redis）+ 上传校验 + 告警展示；家庭维度表另排期 | ✅ 用户默认第 23 轮 / ✅ 家庭默认第 28 轮 / ✅ 家庭级覆盖第 30 轮（Redis，无独立表） |
...
1. 菜谱推荐按「做过次数」进一步加权  
2. 家庭配额运营看板（全量列表 + 批量调整）  
3. （可选）微信正式上架：`VITE_*_RELEASE` 填真实域名；`urlCheck: true`  
...
*最后更新：2026-08-12 · 第 1～31 轮已归档 · 第 31 轮（学习提醒模板对齐 / 统计导出）已落地*
